...
# directory.
#
410TESTS = ck1 knife peon merchant
...
context_switch_asm.o int_handler_wrapper.o keyboard_driver.o timer_driver.o \
driver_core.o driver_init.o circular_buffer.o fork.o
